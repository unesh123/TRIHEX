...
export const OWNER_AVAILABLE: CatalogueOverride[] = [
  ...
  },
  {
    ...
    name: "Gemini 5 TB AI Pro — 12 Months (Full Warranty)",
    productStatus: "PUBLIC",
    complianceStatus: "APPROVED",
    needsDataVerification: false,
    blockedReason: null,
    ...
    shortDescription:
      "Gemini AI Pro 5 TB — 12-Month Full Replacement Warranty Package. Dedicated access, 5 TB Google Cloud storage, and full term warranty.",
  },
  {
  ...
  },
  {
    ...
    shortDescription:
      "Super Grok (xAI) 1-month shared access with high-speed reasoning, Grok 2 / Fun Mode, and direct web access. Full warranty for term.",
  },
  {
    ...
    shortDescription:
      "Super Grok (xAI) 3-month shared access plan with guaranteed full warranty and prompt delivery.",
  },
  {
    ...
    shortDescription:
      "Super Grok (xAI) 6-month shared access plan with extended term warranty and continuous support.",
  },
  {
    ...
    shortDescription:
      "Super Grok (xAI) 9-month shared access plan with priority support and uptime warranty.",
  },
  {
    ...
    shortDescription:
      "Super Grok 1-Year Dedicated Private Plan (Own Account). Full privacy, private chat history, and priority xAI infrastructure access.",
  },
  {
  ...
  },
  {
    ...
    costNpr: 950,
    purchasable: true,
    seedVisibleQuantity: 12,
    shortDescription:
      "Anthropic Claude Pro 1-month high-speed access with Claude 3.5 Sonnet, Projects, and priority capacity.",
  },
  {
