...
const CATALOGUE_V2: ProductDef[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      {
        sku: "CUR-3M-SHARED",
        name: "3 Months Shared Team Seat",
        priceNpr: 4999,
        compareAtNpr: 9999,
        costNpr: 3375,
        stockQty: 25,
      ...
      {
        sku: "CUR-6M-SHARED",
        name: "6 Months Shared Team Seat",
        priceNpr: 8999,
        compareAtNpr: 18999,
        costNpr: 6075,
        stockQty: 20,
      ...
      {
        sku: "CUR-12M",
        name: "12 Months Dedicated Pro Access",
        priceNpr: 15999,
        compareAtNpr: 34999,
        costNpr: 8100,
        stockQty: 12,
  ...
  },
  {
    ...
    variants: [
      ...
      {
        sku: "GAM-3M-SHARED",
        name: "3 Months Shared Workspace",
        priceNpr: 2499,
        compareAtNpr: 5999,
        costNpr: 900,
        stockQty: 30,
      ...
      {
        sku: "GAM-6M-SHARED",
        name: "6 Months Shared Workspace",
        priceNpr: 4199,
        compareAtNpr: 9999,
        costNpr: 1600,
        stockQty: 25,
  ...
  },
  {
    ...
    variants: [
      {
        sku: "SUPA-1M-SHARED",
        name: "1 Month Shared Org Member",
        priceNpr: 1499,
        compareAtNpr: 3499,
        costNpr: 600,
        stockQty: 50,
      ...
      {
        sku: "SUPA-3M-SHARED",
        name: "3 Months Shared Org Member",
        priceNpr: 2999,
        compareAtNpr: 6999,
        costNpr: 1200,
        stockQty: 40,
      ...
      {
        sku: "SUPA-6M-SHARED",
        name: "6 Months Shared Org Member",
        priceNpr: 4699,
        compareAtNpr: 10999,
        costNpr: 2000,
        stockQty: 30,
  ...
  },
  {
    ...
    variants: [
      ...
      {
        sku: "FACT-12M",
        name: "12 Months Enterprise Droid",
        priceNpr: 8999,
        compareAtNpr: 18999,
        costNpr: 3375,
        stockQty: 25,
  ...
  },
  {
    ...
    variants: [
      ...
      {
        sku: "GROK-3M",
        name: "3 Months Dedicated Access",
        priceNpr: 2499,
        compareAtNpr: 5999,
        costNpr: 800,
        stockQty: 10,
  ...
  },
  {
    ...
    variants: [
      {
        sku: "HIGGS-1M-SHARED",
        name: "1 Month Shared Cinema Plan",
        priceNpr: 2999,
        compareAtNpr: 6999,
        costNpr: 1200,
        stockQty: 30,
      ...
      {
        sku: "HIGGS-3M-SHARED",
        name: "3 Months Shared Cinema Plan",
        priceNpr: 6999,
        compareAtNpr: 14999,
        costNpr: 2800,
        stockQty: 20,
      ...
      {
        sku: "HIGGS-6M-SHARED",
        name: "6 Months Shared Cinema Plan",
        priceNpr: 11999,
        compareAtNpr: 24999,
        costNpr: 5200,
        stockQty: 15,
  ...
  },
  {
    ...
    variants: [
      {
        sku: "MANUS-1M-SHARED",
        name: "1 Month Shared Agentic Seat",
        priceNpr: 1899,
        compareAtNpr: 4499,
        costNpr: 700,
        stockQty: 35,
      ...
      {
        sku: "MANUS-3M-SHARED",
        name: "3 Months Shared Agentic Seat",
        priceNpr: 3999,
        compareAtNpr: 8999,
        costNpr: 1600,
        stockQty: 25,
      ...
      {
        sku: "MANUS-6M-SHARED",
        name: "6 Months Shared Agentic Seat",
        priceNpr: 6499,
        compareAtNpr: 14999,
        costNpr: 2800,
        stockQty: 20,
      ...
      {
        sku: "MANUS-12M",
        name: "12 Months Dedicated Agentic Pro",
        priceNpr: 9679,
        compareAtNpr: 22000,
        costNpr: 4050,
        stockQty: 15,
  ...
  },
  {
    ...
    variants: [
      {
        sku: "N8N-1M-SHARED",
        name: "1 Month Shared Cloud Flow",
        priceNpr: 1199,
        compareAtNpr: 2999,
        costNpr: 400,
        stockQty: 50,
      ...
      {
        sku: "N8N-3M-SHARED",
        name: "3 Months Shared Cloud Flow",
        priceNpr: 2199,
        compareAtNpr: 5499,
        costNpr: 800,
        stockQty: 40,
      ...
      {
        sku: "N8N-6M-SHARED",
        name: "6 Months Shared Cloud Flow",
        priceNpr: 3299,
        compareAtNpr: 7999,
        costNpr: 1300,
        stockQty: 30,
