...
const PRODUCTS: ProductSpec[] = [
  ...
  },
  {
    ...
    name: "AI Money Maker Course",
    category: "CLASSIFIED VAULT DROP ✦",
    subtitle: "MASTER AI DIGITAL PRODUCTS & AUTOMATED REVENUE CHANNELS",
    centralHeadline: "BUILD & SCALE AI DIGITAL ASSETS",
    centralSubheadline: "Funnels • Automations • Prompts • Products • Scaling",
    benefitChips: ["50+ System Prompts", "Funnel Blueprints", "Dropship Systems", "Decryption Key"],
    featureRibbon: "COMPLETE 2026 DIGITAL REVENUE ARCHIVE",
    features: [
      { title: "AI Asset Vault", desc: "Build in-demand digital templates and guides." },
      { title: "50+ Master Prompts", desc: "Uncensored prompts for copy, research and sales." },
      { title: "Funnel Blueprints", desc: "High-converting checkout pages and email sequences." },
      { title: "Traffic Generation", desc: "Faceless audience building and viral organic loops." },
      { title: "Dropshipping Ops", desc: "Automated fulfillment workflows and supplier routing." },
      { title: "Offer Engineering", desc: "Package high-ticket digital bundles that sell." },
      { title: "Email Automation", desc: "Automated nurture and objection handling sequences." },
      { title: "SOP Library", desc: "Step-by-step operating procedures for speed." },
      { title: "Encrypted Cloud Vault", desc: "Full 1.8GB archive hosted with lifetime access." },
      { title: "Instant Unlock Key", desc: "Fulfillment decryption key delivered with your order." },
      { title: "Conversion Scripts", desc: "Field-tested buyer psychology closing matrices." },
      { title: "Nepal Commerce Ready", desc: "Designed for international and local commerce." },
    ],
    workflow: ["DISCOVER", "BUILD", "AUTOMATE", "SCALE"],
    perfectFor: ["Entrepreneurs", "Creators", "Freelancers", "Marketers", "Students", "Builders"],
    bottomCta: "UNLOCK CLASSIFIED AI ASSET VAULT",
    colors: { primary: "#059669", secondary: "#10b981", accent: "#34d399", pillBg: "#ecfdf5", pillBorder: "#a7f3d0", glow: "rgba(16,185,129,0.14)" },
  },
  {
    slug: "the-psychology-of-closing-bundle",
    name: "Psychology of Closing",
    category: "HIGH-TICKET SALES VAULT ✦",
    subtitle: "OBJECTION HANDLING, NEGOTIATION & CLOSING FRAMEWORKS",
    centralHeadline: "MASTER THE ART OF HIGH-TICKET SALES",
    centralSubheadline: "Psychology • Objection Scripts • Negotiations • Conversions",
    benefitChips: ["47 Rebuttal Scripts", "Cold Outreach", "Price Anchoring", "Closing Frameworks"],
    featureRibbon: "ELITE B2B & DIRECT SALES BLUEPRINT",
    features: [
      { title: "Objection Playbook", desc: "47 Word-for-word scripts to eliminate hesitation." },
      { title: "Price Anchoring", desc: "Make premium pricing feel like an absolute bargain." },
      { title: "Cold DM Outreach", desc: "Inbound and outbound scripts that get warm replies." },
      { title: "Decision Triggers", desc: "Leverage core human behavioral buying impulses." },
      { title: "B2B Negotiations", desc: "Navigate corporate procurement and budget limits." },
      { title: "WhatsApp Sales", desc: "Turn casual inquiries into paid orders instantly." },
      { title: "Urgency Architecture", desc: "Create genuine buying urgency without pressure." },
      { title: "Follow-Up Systems", desc: "Non-needy follow-up loops that revive dead leads." },
      { title: "Contract Closing", desc: "Smooth transition from proposal to sign and pay." },
      { title: "Mindset Calibration", desc: "Overcome fear of rejection and ask with confidence." },
      { title: "Audio & PDF Vault", desc: "Quick-reference flashcards and deep video training." },
      { title: "Lifetime Vault", desc: "Instant download with permanent reference access." },
    ],
    workflow: ["HOOK", "QUALIFY", "ANCHOR", "CLOSE"],
    perfectFor: ["Sales Leaders", "Founders", "Freelancers", "Agencies", "Consultants", "Closers"],
    bottomCta: "MASTER HIGH-TICKET CLOSING PSYCHOLOGY",
    colors: { primary: "#d97706", secondary: "#b45309", accent: "#f59e0b", pillBg: "#fffbeb", pillBorder: "#fde68a", glow: "rgba(245,158,11,0.14)" },
  },
  {
    slug: "the-passive-rebel-antisocial-leads",
    name: "The Passive Rebel",
    category: "COVERT TRAFFIC BLUEPRINT ✦",
    subtitle: "INBOUND CLIENT ACQUISITION WITHOUT PERSONAL BRANDING",
    centralHeadline: "SCALE INBOUND LEADS FACELESS & COVERT",
    centralSubheadline: "No Camera • No Influencer Status • Pure Systematic Inbound",
    benefitChips: ["Faceless Traffic", "Reddit & SEO Loops", "Automated Scraping", "$500 Valuation"],
    featureRibbon: "SYSTEMATIC ASOCIAL CLIENT ACQUISITION",
    features: [
      { title: "Faceless Authority", desc: "Generate inbound demand without showing your face." },
      { title: "Reddit Traffic Engine", desc: "Ethical community loops driving targeted buyer clicks." },
      { title: "Programmatic Scraping", desc: "Identify qualified prospective clients on autopilot." },
      { title: "Lurker Conversion", desc: "Convert silent profile visitors into booked calls." },
      { title: "Automated DM Funnels", desc: "Hands-off qualification before you spend any time." },
      { title: "Ghost Positioning", desc: "High credibility without vanity metrics or fame." },
      { title: "Niche Dominance", desc: "Find high-margin underserved micro niches." },
      { title: "Offer Packaging", desc: "Create irresistible no-brainer service retainers." },
      { title: "Cold Loop Sprints", desc: "Test new market segments in under 48 hours." },
      { title: "Anti-Burnout Systems", desc: "Zero requirement for daily social media posting." },
      { title: "Full SOP Library", desc: "Ready-to-use workflows, prompts, and templates." },
      { title: "Lifetime Vault", desc: "Complete cloud package unlocked instantly." },
    ],
    workflow: ["POSITION", "TARGET", "CAPTURE", "MONETIZE"],
    perfectFor: ["Introverts", "Developers", "Agencies", "Solo Founders", "Consultants", "Builders"],
    bottomCta: "UNLOCK FACELESS INBOUND ACQUISITION",
    colors: { primary: "#7c3aed", secondary: "#6d28d9", accent: "#8b5cf6", pillBg: "#f5f3ff", pillBorder: "#ddd6fe", glow: "rgba(139,92,246,0.14)" },
  },
];
